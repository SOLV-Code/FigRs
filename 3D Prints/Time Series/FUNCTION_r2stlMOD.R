...
# CODE BELOW HAS BEEN MODIFIED FROM CODE RETRIEVED FROM http://drianwalker.com/r2stl.r on August 6 2013
# NOTE: The original source functions has been superseded by the CRAN package r2stl{},
# but the code below has not yet been updated to use the package.
